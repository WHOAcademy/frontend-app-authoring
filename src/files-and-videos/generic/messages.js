...
const messages = defineMessages({
  ...
  fileSizeError: {
    ...
    defaultMessage: 'Uploaded file(s) must be 400 MB or less. Please resize file(s) and try again.',
    description: 'This error message is shown when user tries to upload a file larger than 400 MB',
  },
